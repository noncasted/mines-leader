...
var ASM_CONSTS = {
  7545264: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 7545319: ($0) => { performance.now = function() { return $0; }; },  
 7545367: ($0) => { performance.now = function() { return $0; }; },  
 7545415: () => { performance.now = Module['emscripten_get_now_backup']; }
};
...
// end include: preamble.js
  ...
  function _WebSocketSendText(instanceId, messagePtr) {
      const instance = webSocketState.instances[instanceId];
      if (!instance || !instance.ws) return -1;
      if (instance.ws.readyState !== 1) return -6;
...
var wasmImports = {
  ...
  "GetLanguageItch": _GetLanguageItch,
