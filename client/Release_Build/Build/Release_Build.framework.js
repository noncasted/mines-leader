...
var ASM_CONSTS = {
  7545152: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 7545207: ($0) => { performance.now = function() { return $0; }; },  
 7545255: ($0) => { performance.now = function() { return $0; }; },  
 7545303: () => { performance.now = Module['emscripten_get_now_backup']; }
};
