...
namespace Internal {
    public static class PrefabGroupsRegistry {
        public const string AssetPath = "Assets/Internal/Editor/Catalogues/Prefabs/PrefabGroups.json";
        ...
        private static string ToFullPath() {
            return Path.Combine(Application.dataPath, "Internal/Editor/Catalogues/Prefabs/PrefabGroups.json");
        }
