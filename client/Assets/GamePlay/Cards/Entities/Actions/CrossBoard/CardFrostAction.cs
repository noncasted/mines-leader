...
namespace GamePlay.Cards
{
    ...
    public class CardFrostAction : ICardAction
    {
        ...
        public class Snapshot : ICardActionSync<CardActionSnapshot.Frost>
        {
            ...
            public async UniTask Sync(IReadOnlyLifetime lifetime, CardActionSnapshot.Frost payload)
            {
                ...
                foreach (var position in payload.AffectedCells)
                    _animator.AddEffect(payload.EffectId, CellEffectType.Frost, payload.TargetPlayer, position);
