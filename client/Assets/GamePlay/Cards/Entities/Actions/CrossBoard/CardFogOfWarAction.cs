...
namespace GamePlay.Cards
{
    public class CardFogOfWarAction : ICardAction
    {
        ...
        public class Snapshot : ICardActionSync<CardActionSnapshot.FogOfWar>
        {
            ...
            public async UniTask Sync(IReadOnlyLifetime lifetime, CardActionSnapshot.FogOfWar payload)
            {
                ...
                foreach (var position in payload.AffectedCells)
                    _animator.AddEffect(payload.EffectId, CellEffectType.Fog, payload.TargetPlayer, position);
