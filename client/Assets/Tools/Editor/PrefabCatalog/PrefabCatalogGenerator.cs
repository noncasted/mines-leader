...
namespace Tools {
    public static class PrefabCatalogGenerator {
        public const string GroupsFolder = "Assets/Tools/Runtime/PrefabCatalog/Groups";
        public const string GeneratedPrefix = "Assets/Resources/Generated/";
        ...
        public static bool IsGeneratedPath(string path) {
            ...
            return path.StartsWith(GeneratedPrefix, StringComparison.OrdinalIgnoreCase) ||
                   path.Equals("Assets/Resources/Generated", StringComparison.OrdinalIgnoreCase);
        }
        ...
        private static void WarnIfIncluded(string path) {
            ...
            if (metadata.Included)
                Debug.LogError($"[PrefabCatalogGenerator] Skipping Resources/Generated prefab: {path}");
        }
        ...
        private static void AssignGeneratedTargets(List<PrefabGroupDefinition> groups) {
            foreach (var group in groups) {
                ...
                if (assemblies.Count == 1) {
                    ...
                    group.EmitToolsPartial = false;
                    continue;
                }

                group.TargetNamespace = "Tools";
                group.GeneratedFolder = PrefabsCatalogClassGenerator.ToolsGeneratedFolder;
                group.EmitToolsPartial = true;
            }
        }
        ...
        private static bool IsConsumerAssembly(string assemblyName) {
            ...
            if (assemblyName == "Tools.Runtime" || assemblyName == "Tools.Editor")
                return false;
