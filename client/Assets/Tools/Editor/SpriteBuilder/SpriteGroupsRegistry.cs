...
namespace Tools {
    public static class SpriteGroupsRegistry {
        public const string AssetPath = "Assets/Tools/Editor/SpriteBuilder/SpriteGroups.json";
        ...
        private static string ToFullPath() {
            return Path.Combine(Application.dataPath, "Tools/Editor/SpriteBuilder/SpriteGroups.json");
        }
