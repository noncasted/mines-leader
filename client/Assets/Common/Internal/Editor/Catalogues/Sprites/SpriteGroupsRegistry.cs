...
namespace Internal {
    public static class SpriteGroupsRegistry {
        public const string AssetPath = "Assets/Common/Internal/Editor/Catalogues/Sprites/SpriteGroups.json";
        ...
        private static string ToFullPath() {
            return Path.Combine(Application.dataPath, "Common/Internal/Editor/Catalogues/Sprites/SpriteGroups.json");
        }
