...
[CustomEditor(typeof(FSR3Options))]
public class FSR3OptionsEditor : UpscalerOptionsEditor
{
    ...
    {
        base.OnEnable();
        // Find each property by its exact field name in FSR3Options.cs
        m_QualityMode = serializedObject.FindProperty("m_FSR3QualityMode");
