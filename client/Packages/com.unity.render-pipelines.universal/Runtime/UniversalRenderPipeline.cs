...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        /// </value>
        public IReadOnlyList<string> availableUpscalerNames => upscaling?.upscalerNames ?? Array.Empty<string>();
...
#pragma warning restore 618
        ...
        void RenderCameras(ScriptableRenderContext renderContext, List<Camera> cameras)
        {
            ...
            using (new ContextRenderingScope(renderContext, cameras))
            {
                ...
                usePersistentConstantBuffers = cbSettings != null && cbSettings.usePersistentConstantBuffers;
        ...
        /// Read once per frame, and the setting cannot change between the cameras of a frame.
        /// </summary>
        internal static bool usePersistentConstantBuffers { get; private set; }
