...
**FIRST:** Read `.agents/docs/CODE_STYLE_FULL.md` for the authoritative style rules. The summary below is for quick reference — the docs file is the source of truth.
