...
**FIRST:** Read `.agents/AGENTS.md` (keyword → documentation table) and `.agents/docs/VOCABULARY.md` to understand the full documentation landscape.
...
2. Read `.agents/docs/GAMEPLAY.md` CardType section
...
2. Check if error messages/patterns are documented in `.agents/docs/ERRORS.md`
...
2. Check against `.agents/docs/VOCABULARY.md`
...
- Check if `.agents/docs/DECISION_TREES.md` covers the choice
...
### 8. AGENTS.md Keyword Table

Check `.agents/AGENTS.md` keyword → documentation mapping table:
- If new docs or rules files were added — are they linked in the table?
