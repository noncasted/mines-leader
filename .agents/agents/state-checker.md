...
**FIRST:** Read `.agents/docs/COMMON_ORLEANS.md` for the authoritative rules on grain state, registration, and StateCollection. The summary below is for quick reference — the docs file is the source of truth.
