...
**FIRST:** Read `.agents/docs/COMMON_ORLEANS.md` for the authoritative grain rules. The summary below is for quick reference — the docs file is the source of truth.
