...
### Recommended Reading Order
1. **START HERE:** [CODE_STYLE_FULL.md](CODE_STYLE_FULL.md) – Organization, naming, structure
...
### Recommended Reading Order
1. **START HERE:** [API_DESIGN_FULL.md](API_DESIGN_FULL.md) – Naming, return types, error handling
