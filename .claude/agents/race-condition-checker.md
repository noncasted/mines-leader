...
**FIRST:** Read `.claude/rules/ORLEANS_GRAINS.md` for grain threading model context and `docs/COMMON_ORLEANS.md` (Grain Lifecycle section) for activation/timer details. The summary below is for quick reference — the rules files are the source of truth.
