...
**FIRST:** Read `.claude/docs/COMMON_ORLEANS.md` (Grain pattern + Grain Lifecycle sections) for grain threading model context, activation, and timer details. The summary below is for quick reference — the docs file is the source of truth.
