...
**FIRST:** Read `.claude/docs/COMMON_LIFETIMES.md` and `.claude/docs/COMMON_REACTIVE_BASICS.md` for the authoritative rules. The summary below is for quick reference — the docs files are the source of truth.
