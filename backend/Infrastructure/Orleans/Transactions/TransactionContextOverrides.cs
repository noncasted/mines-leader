...
public static class TransactionContextOverrides
{
    ...
    private static readonly MethodInfo SetTransactionInfoMethod = TransactionContextType.GetMethod("SetTransactionInfo",
        BindingFlags.NonPublic | BindingFlags.Static
    )!;

    private static readonly MethodInfo ClearMethod = TransactionContextType.GetMethod("Clear",
        BindingFlags.NonPublic | BindingFlags.Static
    )!;
