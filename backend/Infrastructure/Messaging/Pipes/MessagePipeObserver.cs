...
public class MessagePipeObserver : IMessagePipeObserver
{
    ...
    {
        _logger.LogTrace("[Messaging] [Pipe] Binding one-way handler");
        ...
        _logger.LogTrace("[Messaging] [Pipe] One-way handler bound successfully");
    }

    public void BindResponseHandler(Func<object, Task<object>> handler)
    {
        _logger.LogTrace("[Messaging] [Pipe] Binding response handler");
        ...
        _logger.LogTrace("[Messaging] [Pipe] Response handler bound successfully");
    }

    public Task Send(object message)
    {
        _logger.LogTrace("[Messaging] [Pipe] Processing one-way message {MessageType}", message.GetType().Name);
        ...
        try
        {
            ...
            _logger.LogTrace("[Messaging] [Pipe] Successfully processed one-way message {MessageType}",
                message.GetType().Name
            );
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "[Messaging] [Pipe] Failed to process one-way message {MessageType}",
                message.GetType().Name
            );
            throw;
        }
    ...
    public async Task<TResponse> Send<TResponse>(object message)
    {
        ...
        if (_responseHandler == null)
        {
            _logger.LogError("[Messaging] [Pipe] No response handler bound to process message {MessageType}",
                message.GetType().Name
            );
        ...
        {
            _logger.LogError(ex, "[Messaging] [Pipe] Failed to process request-response message {MessageType}",
                message.GetType().Name
            );
            throw;
        }
