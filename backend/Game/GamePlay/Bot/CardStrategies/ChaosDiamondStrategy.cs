...
public class ChaosDiamondStrategy : IBotCardStrategy {
    public ChaosDiamondStrategy(IBotContext context, BotBoardUtils boardUtils, IBotCommandUtils commandUtils) {
        _context = context;
    ...
    public IReadOnlyList<CardType> TargetCards { get; } = [CardType.ChaosDiamond];
    ...
    public bool Execute(Guid cardId, CardType cardType) {
        ...
        var payload = new CardUsePayload.ChaosDiamond { Type = cardType, Position = position };
