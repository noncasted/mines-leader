...
public class OpponentFlagReshuffleTests {
    ...
    public void Use_MovesFlags() {
        ...
        board.Cells[new Position(2, 1)].Should().BeAssignableTo<ITakenCell>()
        ...
        takenCells.Count(c => c.IsFlagged).Should().Be(1,
    ...
    public void Use_NoFlags_NoChange() {
        ...
        board.Cells.Values
            .Where(c => c.Status == CellStatus.Taken)
            .Cast<ITakenCell>()
            .Count(c => c.IsFlagged).Should().Be(0);
    }
    ...
    public void Use_AllCellsFlagged_NoUnflaggedTargets() {
        ...
        board.Cells[new Position(1, 1)].Should().BeAssignableTo<ITakenCell>()
            .Which.IsFlagged.Should().BeTrue();
    }
    ...
    public void Use_MultipleFlags_AllRelocated() {
        ...
        inRangeCells.Count(c => c.IsFlagged).Should().Be(2,
